...
<div class="col-12 pb-3">
            ...
            <tbody>
             @foreach ($exam->questions as $ques) 
                <tr>
                    ...
                    <td> 
                      <a class="btn btn-info"  href="{{url("dashboard/exams/edit-question/$exam->id/$ques->id")}}" ><i class="fas fa-edit"></i></a>
                     </td>
                </tr>
    ...
    <div class="col-md-6 offset-md-1 pb-3">
        <a href="{{url("dashboard/exams/show/$exam->id")}}" class="btn  btn-sm btn-primary">Back</a>
        <a href="{{url("dashboard/exams")}}" class="btn  btn-sm btn-secondary">Back to all Exams</a>
    </div>
