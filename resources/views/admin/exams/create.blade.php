      ...
      <div class="row">
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name_en" placeholder="Enter name in english">
                </div>
              </div>
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name_ar" placeholder="Enter name in arabic">
                </div>
              </div>
      </div>
               ...
               <div class="form-group">
                 ...
                 <textarea name="desc_en" class="form-control summernote"  rows="5"></textarea>
               </div>
      
               <div class="form-group">
                <label>الوصف باللغة العربية</label>
                <textarea name="desc_ar" class="form-control summernote"  rows="5"></textarea>
              </div>
